		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comtestsampletestapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comtestsampletestapp-display": {
								"semanticObject": "comtestsampletestapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.test.sampletestapp",
									"url": sap.ui.require.toUrl("com/test/sampletestapp")
								}
							}
						}
					}
